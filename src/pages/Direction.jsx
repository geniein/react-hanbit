  ...
  return (
    <div className="flex w-full flex-col gap-6">
      ...
      <section className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="rounded-[36px] p-6 sm:p-8" style={{ backgroundColor: "var(--surface-soft)", boxShadow: "var(--shadow-soft)" }}>
          ...
          <div className="mt-6 space-y-5 text-sm leading-8 sm:text-base" style={{ color: "var(--muted)" }}>
            <div>
              <div className="text-xs font-semibold uppercase tracking-[0.18em]" style={{ color: "var(--muted)" }}>주소</div>
              <div className="mt-1">천안시 동남구 충무로 158-35, 럭스프라자 501호</div>
            </div>
            <div>
              <div className="text-xs font-semibold uppercase tracking-[0.18em]" style={{ color: "var(--muted)" }}>교통</div>
              <div className="mt-1">쌍용역 1번 출구에서 648m (도보10분소요)</div>
            </div>
            <div>
              <div className="text-xs font-semibold uppercase tracking-[0.18em]" style={{ color: "var(--muted)" }}>상담</div>
